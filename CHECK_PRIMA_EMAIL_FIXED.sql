-- Check Prima institute email registration status (FIXED)
...
-- Check how many admin_invites exist for Prima institute
SELECT COUNT(*) as admin_invites_count
FROM public.admin_invites
WHERE institute_id IN (SELECT id FROM public.institutes WHERE institute_code = '12345');
